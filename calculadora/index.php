    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="#page-top">Calculadora Soma</a>
        ...
        <header class="bg-primary bg-gradient text-white">
            <div class="container px-4 text-center">
                <h1 class="fw-bolder">Bem vindo a calculadora de soma</h1>
                <p class="lead">Este aplicativo WEB foi construido utilizando HTML5, PHP e o Framework Bootstrap</p>
            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <p class="lead">Entre com dois valores e clique no botão somar para calcular:</p>
               ...
               $n1=$_POST["n1"];
                $n2=$_POST["n2"];
                $soma=$n1 + $n2;
                echo "Resultado:<br><input type='text' value='$soma'/>"; 
        ...
        <section id="contact">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>Quem Sou?</h2>
                        <p class="lead">Sou Alisson estudante de informática para internet</p>
                        <div >
                            <h2 class="mb-4">Dá um Fork nos meus repositórios</h2>
                            <a class="btn btn-xl btn-dark" href="https://github.com/AlissonED">Alisson Evangelista</a>
                        </div>
                    </div>
                </div>
            </div>
